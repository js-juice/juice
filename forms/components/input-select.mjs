...
>>>>>>> Stashed changes
            ...
            ".tab::after": {
                ...
                background: "var(--form-select-tab-arrow, var(--select-arrow-color, var(--form-accent-color, #0059ff)))",
                left: "50%",
                top: "50%",
...
=======
            ...
            ".select-options .select-option.selected .option-icon": {
                color:
                    "var(--form-select-option-icon-selected-color, var(--form-select-option-icon-selected-bg, var(--form-select-option-icon-color, var(--form-select-option-icon-bg, currentColor))))"
            },
            ...
            ".select-options .select-option .option-info": {
                ...
                color:
                    "var(--form-select-option-info-color, var(--form-select-option-item-color, var(--form-select-option-color, currentColor)))",
            ...
            ".select-options .select-option.selected .option-info": {
                color:
                    "var(--form-select-option-info-selected-color, var(--form-select-option-item-selected-color, var(--form-select-option-selected-color, currentColor)))"
            },
            ".select-options .select-option:hover": {
                ...
                color:
                    "var(--form-select-option-item-hover-color, var(--form-select-option-hover-color, var(--form-select-option-item-color, var(--form-select-option-color, #333333))))"
            },
            ".select-options .select-option.selected": {
                backgroundColor:
