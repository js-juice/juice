 ...
 * @class Particle
 * @param {number, keyframed-value} x - Initial X position
 * @param {number, keyframed-value} y - Initial Y position
 * @param {number, keyframed-value} velocityX - X velocity
 * @param {number, keyframed-value} velocityY - Y velocity
 * @param {number, keyframed-value} size - Particle size
 * @param {number, keyframed-value} lifespan - Particle lifespan in seconds
